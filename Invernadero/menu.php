...
<nav>
    <ul>
        ...
        <li><a href="leecosa.php">graficas</a></li>
        <li><a href="humSue.php">humedad suelo</a></li>
        <li><a href="humrela.php">humedad relativa</a></li>
        <li><a href="temperatura.php">Temperatura</a></li>
		<li><a href="luz.php">Luz</a></li>
		<li><a href="tambo.php">tanque</a></li>
		<li><a href="macronut.php">Macronutrientes</a></li>
		<li><a href="micronut.php">Micronutrientes</a></li>
    </ul>
</nav>
=======
 <?php
