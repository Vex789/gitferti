...
namespace Ferti_Irrigacion1._0 {
    ...
    public partial class usuarios : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsuariosRow AddUsuariosRow(string Usuario, string Password, string Rol) {
...
namespace Ferti_Irrigacion1._0.usuariosTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Usuarios` WHERE ((`IdUsuario` = ?) AND ((? = 1 AND `Usuario` IS NULL" +
                ") OR (`Usuario` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) A" +
                "ND ((? = 1 AND `Rol` IS NULL) OR (`Rol` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Usuarios` (`Usuario`, `Password`, `Rol`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Usuarios` SET `Usuario` = ?, `Password` = ?, `Rol` = ? WHERE ((`IdUsuario" +
                "` = ?) AND ((? = 1 AND `Usuario` IS NULL) OR (`Usuario` = ?)) AND ((? = 1 AND `P" +
                "assword` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Rol` IS NULL) OR (`Rol` " +
                "= ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Ferti_Irrigacion1._0.Properties.Settings.Default.usuarios;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdUsuario, Usuario, [Password], Rol FROM Usuarios";
        ...
        public virtual int Delete(int Original_IdUsuario, string Original_Usuario, string Original_Password, string Original_Rol) {
        ...
        public virtual int Insert(string Usuario, string Password, string Rol) {
            if ((Usuario == null)) {
        ...
        public virtual int Update(string Usuario, string Password, string Rol, int Original_IdUsuario, string Original_Usuario, string Original_Password, string Original_Rol) {
            if ((Usuario == null)) {
